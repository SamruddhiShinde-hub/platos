...
export const Navbar = () => {
  ...
  return (
    <>
      ...
      {/* Mobile Menu — rendered outside <nav> so backdrop-filter doesn't create a new containing block for this fixed child */}
      {isMenuOpen && (
        <div className="fixed inset-0 top-[73px] z-40 bg-background md:hidden">
